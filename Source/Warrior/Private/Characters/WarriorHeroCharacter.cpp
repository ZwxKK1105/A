...
#include "DataAssets/StartUpData/DataAsset_HeroStartUpdate.h"
...
void AWarriorHeroCharacter::PossessedBy(AController* NewController)
{
	...
	{
		const FString ASCText = FString::Printf(TEXT("Owner Actor:%s,AvatarActor:%s"), *WarriorAbilitySystemComponent->GetOwnerActor()->GetActorLabel(),
	...
	*/
	...
	{
		if (UDataAsset_StartUpdateBase* LoadedData = CharacterStartUpData.LoadSynchronous())
		{
			...
			LoadedData->GiveToWarriorAbilitySystemComponent(WarriorAbilitySystemComponent, AbilityApplyLevel);
		}
	}
