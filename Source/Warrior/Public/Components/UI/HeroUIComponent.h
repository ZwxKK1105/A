...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnAbilityIconUpdatedDelegate, FGameplayTag, AbilityInputTag, TSoftObjectPtr<UMaterialInterface>, SoftAbilityIconMaterial);
