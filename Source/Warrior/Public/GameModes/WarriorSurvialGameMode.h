...
struct FWarriorEnemyWaveSpawnerTableRow : public FTableRowBase
{
	...
	UPROPERTY(EditAnywhere)
	TArray<FWarriorEnemyWaveSpawnerInfo> EnemyWaveSpawnerDedinitions;
...
private:
	...
	UFUNCTION()
	void OnEnemyDestroy(AActor* DeadActor);
	...
	UPROPERTY(EditAnywhere,BlueprintReadOnly, Category = "WaveDefinition",meta=(AllowPrivateAccess="true"))
